  ...
  return (
    <div className='bg-white sticky top-0 z-50'>
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="relative z-40 lg:hidden" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? '#1f2937' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "anasnadkar24@gmail.com" ? <div className="flow-root">
                ...
                {user ? <div className="flow-root">
                  ...
                  <div className="flow-root">
                    <Link to={'/allproducts'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
      ...
      <header className="relative bg-white">
        ...
        <nav aria-label="Top" className="bg-gray-50 px-4 sm:px-6 lg:px-8 shadow-xl " style={{ backgroundColor: mode === 'dark' ? '#1f2937' : '', color: mode === 'dark' ? 'white' : '', }}>
          <div className="">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                 ...
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === 'anasnadkar28@gmail.com' ? 
